...
def tpl_preprocessor_new(tpl_preproc_py, tpl_preprocessor_obj, full_path_args_dict):
    """
...
def tpl_preprocessor_old(sublime_working_dir, working_dir, dir_label, full_curr_path, file_path):
    """
